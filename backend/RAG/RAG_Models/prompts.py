...
2. Explain the chunk's meaning and significance in simple terms, focusing on its relationship to the given classifications.
...
You are an AI specializing in analyzing Legal Terminology within Terms of Service contracts. Compare the following two texts and determine a similarity score between them based on the legal implications, rights, obligations, or conditions they convey to the reader. Consider the intent and type of permission, restriction, or disclosure each text is communicating. Ignore specifics such as the company name and focus on the broader legal meaning and implications.
Text 1: "{prompt_text}" 
