...
def benchmark_models(test_cases):
    ...
    for input_data, true_explanations in test_cases:
    ...
    P_corrective, R_corrective, F1_corrective = calculate_bertscore(true_explanations, corective_explanations)
    P_rag, R_rag, F1_rag = calculate_bertscore(true_explanations, rag_explanations)
    
    print('Overall BERTScore for Corrective RAG: Percision = ', P_corrective, 'Recall = ', R_corrective, 'F1 = ', F1_corrective)
    print('Overall BERTScore for Base RAG: Percision = ', P_rag, 'Recall = ', R_rag, 'F1 = ', F1_rag)
    return F1_corrective, F1_rag

if __name__ == '__main__':
    test_cases = [
        ("We may collect information about your location and device usage to enhance your experience.", 'The company may collect information about your location and device usage to enhance your experience. Watch out as they may do this without your consent.'),
    ]
